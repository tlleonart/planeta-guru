...
export const MainCarouselSlideCard: FC<MainCarouselSlideCardProps> = ({ name, description, slug, type }) => {
    const t = useTranslations('MainCarouselCard')
        ...
        >
            <div className="flex flex-col md:h-full md:justify-between ">
                ...
                <div className="flex justify-start">
                    ...
                    >
                        <Link href={`/products/${type}/${slug}`}>{t("watch")}</Link>
                    </Button>
                </div>
            </div>
        </div>
