...
export const AdBannerWrapper: FC = async () => {
    ...
    const nameText = adBanner.descriptions?.find((description) => description.descriptionTypeId === 6)?.text ?? ""
    const descriptionText = adBanner.descriptions?.find((description) => description.descriptionTypeId === 1)?.text ?? ""
