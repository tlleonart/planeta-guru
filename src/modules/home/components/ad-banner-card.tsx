/** biome-ignore-all lint/security/noDangerouslySetInnerHtml: Required for rendering HTML content from CMS - sanitized with DOMPurify */
  ...
  return (
    <div className="flex md:ml-4 md:mr-0 mx-2 xl:ml-16 bg-main/20 p-4 sm:p-6 md:p-3 lg:p-6 backdrop-blur-lg">
      <div className="flex flex-col justify-between items-start gap-8 text-center">
        <div>
          <Heading className="text-base sm:text-3xl md:text-xl xl:text-2xl font-bold mb-1 md:mb-2w-full relative rounded-none">
            {name}
          </Heading>
          <Paragraph
