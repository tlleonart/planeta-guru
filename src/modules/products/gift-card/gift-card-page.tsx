...
import { GiftCardCard } from "./components/gift-card-card";
import { GiftCardContainer } from "./components/gift-card-container";
...
/**
 * Server Component: Página principal de Gift Card
 ...
 */
export const GiftCardPage: FC<GiftCardPageProps> = ({
  product,
  walletAmount = 0,
  walletId = 0,
}) => {
  ...
  return (
    <main>
      ...
      <section className="h-full mb-2 md:mb-4">
        <GiftCardContainer product={product} variant="info">
